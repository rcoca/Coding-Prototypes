A place to put algorithm problems and solutions. Not only Leetcode, but also other coding problems I found interesting and studied.
 ...
 * rulesParser: a parser for a rules language - based on boost::spirit::qi
